...
class IntlPhoneCustomField extends StatefulWidget {
  ...
  @override
  State<IntlPhoneCustomField> createState() => _IntlPhoneFieldState();
}
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: widget.decoration.copyWith(
        ...
        counterStyle: TextStyle(color: AppColors.whiteColor, fontSize: 12.sp),
    ...
    return DecoratedBox(
      ...
      child: Stack(
        ...
        children: [
          InkWell(
            ...
            child: Padding(
              ...
              child: Column(
               ...
               Text(widget.mobilNo==true?"":"Mobile*",
                        style: TextStyle(
                            fontSize: 10.sp,
          ...
          Positioned(
              top: 8,
              child: widget.mobilNo==true?Text("WhatsApp", style: TextStyle(
                  fontSize: 10.sp,
                  color:AppColors.labelGreyColor,
                  fontFamily: fontFamily,
