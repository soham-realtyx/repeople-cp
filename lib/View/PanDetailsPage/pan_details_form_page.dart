...
class PanFormDetailsPage extends StatefulWidget {
  const PanFormDetailsPage({super.key});

  @override
  State<PanFormDetailsPage> createState() => _PanFormDetailsPageState();
}

class _PanFormDetailsPageState extends State<PanFormDetailsPage> {
  @override
  void initState() {
    super.initState();
  }
