...
class GSTFormDetailsPage extends StatefulWidget {
  const GSTFormDetailsPage({super.key});

  @override
  State<GSTFormDetailsPage> createState() => _GSTFormDetailsPageState();
}

class _GSTFormDetailsPageState extends State<GSTFormDetailsPage> {
  @override
  void initState() {
    super.initState();
  }
