...
class _ContactDetailsPageState extends State<ContactDetailsPage> {
  ...
  Widget checkIfMyCompanyIsRegisteredData(){
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("Check if my Company is registered",style: semiBoldTextStyle(txtColor: AppColors.appThemeColor,fontWeight: FontWeight.w600,fontSize: 14)),
          const SizedBox(
            height: 20,
          ),
          Form(
            ...
            child: Column(
              children: [
                ...
                simpleTextFieldNewWithCustomization(
                    ...
                    validator: (value) =>
                        validation(value, "Please enter correspondence Address")),
              ],
            ),
          ),
          const SizedBox(
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Point of Contact Details",style: semiBoldTextStyle(txtColor: AppColors.appThemeColor,fontWeight: FontWeight.w600,fontSize: 14)),
            const SizedBox(
              height: 20,
            ),
            simpleTextFieldNewWithCustomization(
            ...
            phoneNumberTextField(
                cntRegistration.txtPointOfMobile),
            const SizedBox(
              height: 16,
            ),
            simpleTextFieldNewWithCustomization(
                ...
                textCapitalization: TextCapitalization.sentences,
                validator: (value) =>
                    validation(value, "Please enter email")),
          ],
        ),
      ),
    );
  ...
  Widget saveButton() {
    return Padding(
        ...
        child: OnTapButton(
            onTap: () {
              if (cntRegistration.contactDetailsFormKey.currentState!.validate()||cntRegistration.pointOfContactDetailsFormKey.currentState!.validate()) {

              Get.to(()=> RegistrationSuccessPage(isRegisteredSuccess: cntRegistration.isResisterShowScreen.value=true,));
              }
            },
            height: 40.w,
